...
pub const F_SHEAR_2D: usize = Viscosity::Shear(0.0, 0.0).nb_fields(Dim::D2.value());
...
pub const C_SHEAR_1D: usize = Viscosity::Shear(0.0, 0.0).nb_transforms(Dim::D1.value());
...
pub const C_SHEAR_2D: usize = Viscosity::Shear(0.0, 0.0).nb_transforms(Dim::D2.value());
